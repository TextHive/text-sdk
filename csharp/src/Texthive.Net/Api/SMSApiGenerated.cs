...
namespace Texthive.Net.Api
{
    ...
    public partial class SMSApiGenerated : ISMSApi
    {
        ...
        /// <returns></returns>
        public SMSApiGenerated(Texthive.Net.Client.Configuration configuration)
        {
        ...
        public SMSApiGenerated(Texthive.Net.Client.ISynchronousClient client, Texthive.Net.Client.IAsynchronousClient asyncClient, Texthive.Net.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Texthive.Net.Client.ApiResponse<SMSPayload> localVarResponse = GetContactInfoWithHttpInfo(phoneNumber, retrieveIfDoesNotExists, sentId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SMSPayload</returns>
        public Texthive.Net.Client.ApiResponse<SMSPayload> GetContactInfoWithHttpInfo(string phoneNumber, bool retrieveIfDoesNotExists, string sentId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'phoneNumber' is set
            if (phoneNumber == null)
            {
                throw new Texthive.Net.Client.ApiException(400, "Missing required parameter 'phoneNumber' when calling SMSApi->GetContactInfo");
            }
        ...
        {
            Texthive.Net.Client.ApiResponse<SMSPayload> localVarResponse = await GetContactInfoWithHttpInfoAsync(phoneNumber, retrieveIfDoesNotExists, sentId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
