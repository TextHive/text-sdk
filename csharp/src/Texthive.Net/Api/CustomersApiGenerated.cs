...
namespace Texthive.Net.Api
{
    ...
    public partial class CustomersApiGenerated : ICustomersApi
    {
        ...
        /// <returns></returns>
        public CustomersApiGenerated(Texthive.Net.Client.Configuration configuration)
        {
        ...
        public CustomersApiGenerated(Texthive.Net.Client.ISynchronousClient client, Texthive.Net.Client.IAsynchronousClient asyncClient, Texthive.Net.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Texthive.Net.Client.ApiResponse<Customer> localVarResponse = CreateCustomerWithHttpInfo(body);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Customer</returns>
        public Texthive.Net.Client.ApiResponse<Customer> CreateCustomerWithHttpInfo(string body, int operationIndex = 0)
        {
            // verify the required parameter 'body' is set
            if (body == null)
            {
                throw new Texthive.Net.Client.ApiException(400, "Missing required parameter 'body' when calling CustomersApi->CreateCustomer");
            }
        ...
        {
            Texthive.Net.Client.ApiResponse<Customer> localVarResponse = await CreateCustomerWithHttpInfoAsync(body, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Customer)</returns>
        public virtual async System.Threading.Tasks.Task<Texthive.Net.Client.ApiResponse<Customer>> CreateCustomerWithHttpInfoAsync(string body, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Texthive.Net.Client.ApiResponse<Object> DeleteCustomerWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Texthive.Net.Client.ApiException(400, "Missing required parameter 'id' when calling CustomersApi->DeleteCustomer");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public virtual async System.Threading.Tasks.Task<Texthive.Net.Client.ApiResponse<Object>> DeleteCustomerWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Texthive.Net.Client.ApiResponse<List<Customer>> localVarResponse = GetAllCustomersWithHttpInfo(page, pageSize);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;Customer&gt;</returns>
        public Texthive.Net.Client.ApiResponse<List<Customer>> GetAllCustomersWithHttpInfo(int page, int pageSize, int operationIndex = 0)
        {
            Texthive.Net.Client.RequestOptions localVarRequestOptions = new Texthive.Net.Client.RequestOptions();
            ...
            localVarRequestOptions.QueryParameters.Add(Texthive.Net.Client.ClientUtils.ParameterToMultiMap("", "page", page, "int32"));
            localVarRequestOptions.QueryParameters.Add(Texthive.Net.Client.ClientUtils.ParameterToMultiMap("", "pageSize", pageSize, "int32"));
        ...
        {
            Texthive.Net.Client.ApiResponse<List<Customer>> localVarResponse = await GetAllCustomersWithHttpInfoAsync(page, pageSize, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Customer&gt;)</returns>
        public virtual async System.Threading.Tasks.Task<Texthive.Net.Client.ApiResponse<List<Customer>>> GetAllCustomersWithHttpInfoAsync(int page, int pageSize, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Texthive.Net.Client.ApiResponse<Customer> localVarResponse = GetCustomerByIdWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Customer</returns>
        public Texthive.Net.Client.ApiResponse<Customer> GetCustomerByIdWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Texthive.Net.Client.ApiException(400, "Missing required parameter 'id' when calling CustomersApi->GetCustomerById");
            }
        ...
        {
            Texthive.Net.Client.ApiResponse<Customer> localVarResponse = await GetCustomerByIdWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Customer)</returns>
        public virtual async System.Threading.Tasks.Task<Texthive.Net.Client.ApiResponse<Customer>> GetCustomerByIdWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Texthive.Net.Client.ApiResponse<Customer> localVarResponse = UpdateCustomerWithHttpInfo(id, customersUpdateCustomerRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Customer</returns>
        public Texthive.Net.Client.ApiResponse<Customer> UpdateCustomerWithHttpInfo(string id, CustomersUpdateCustomerRequest customersUpdateCustomerRequest, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Texthive.Net.Client.ApiException(400, "Missing required parameter 'id' when calling CustomersApi->UpdateCustomer");
            }

            // verify the required parameter 'customersUpdateCustomerRequest' is set
            if (customersUpdateCustomerRequest == null)
            {
                throw new Texthive.Net.Client.ApiException(400, "Missing required parameter 'customersUpdateCustomerRequest' when calling CustomersApi->UpdateCustomer");
            }
        ...
        {
            Texthive.Net.Client.ApiResponse<Customer> localVarResponse = await UpdateCustomerWithHttpInfoAsync(id, customersUpdateCustomerRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
