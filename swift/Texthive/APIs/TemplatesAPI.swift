...
open class TemplatesAPI {
     ...
     */
    @discardableResult
    open class func createTemplateSync(templateCreateRequest: TemplateCreateRequest, apiResponseQueue: DispatchQueue = TexthiveAPI.apiResponseQueue, completion: @escaping ((_ data: ResponsesTemplateResponse?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func createTemplateWithRequestBuilder(
        ...
        do {
            ...
            let localVariableRequestBuilder: RequestBuilder<ResponsesTemplateResponse>.Type = TexthiveAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getTemplatesForCustomerSync(customerId: String, apiResponseQueue: DispatchQueue = TexthiveAPI.apiResponseQueue, completion: @escaping ((_ data: [ResponsesTemplateResponse]?, _ error: Error?) -> Void)) -> RequestTask {
