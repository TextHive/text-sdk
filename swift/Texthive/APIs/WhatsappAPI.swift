...
open class WhatsappAPI {
     ...
     */
    @discardableResult
    open class func getWhatsappContactSync(phoneNumber: String, retrieveIfDoesNotExists: Bool, sentId: String? = nil, apiResponseQueue: DispatchQueue = TexthiveAPI.apiResponseQueue, completion: @escaping ((_ data: WhatsAppPayload?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getWhatsappContactWithRequestBuilder(
        ...
        do {
            ...
            let localVariableRequestBuilder: RequestBuilder<WhatsAppPayload>.Type = TexthiveAPI.requestBuilderFactory.getBuilder()
