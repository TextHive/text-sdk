...
open class MessagesAPI {
     ...
     */
    @discardableResult
    open class func sendMessageToContactSync(sendMessageToContactRequest: SendMessageToContactRequest, apiResponseQueue: DispatchQueue = TexthiveAPI.apiResponseQueue, completion: @escaping ((_ data: MessagesSendMessageToContactResponse?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func sendMessageToContactWithRequestBuilder(
        ...
        do {
            ...
            let localVariableRequestBuilder: RequestBuilder<MessagesSendMessageToContactResponse>.Type = TexthiveAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func sendMessageToPhoneNumberSync(sendMessageToPhoneNumberRequest: SendMessageToPhoneNumberRequest, apiResponseQueue: DispatchQueue = TexthiveAPI.apiResponseQueue, completion: @escaping ((_ data: MessagesSendMessageToPhoneNumberResponse?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func sendMessageToPhoneNumberWithRequestBuilder(
        ...
        do {
            try Authentication.setAuthenticationParameters(headers: &localVariableHeaderParameters, url: &localVariableUrlComponents, in: "header", name: "x-api-key", value: TexthiveAPI.apiKey, prefix: nil)
            try Authentication.setAuthenticationParameters(headers: &localVariableHeaderParameters, url: &localVariableUrlComponents, in: "", name: "", value: TexthiveAPI.bearerAuth, prefix: nil)
            let localVariableRequestBuilder: RequestBuilder<MessagesSendMessageToPhoneNumberResponse>.Type = TexthiveAPI.requestBuilderFactory.getBuilder()
            let URLString = localVariableUrlComponents?.string ?? localVariableURLString
            return localVariableRequestBuilder.init(method: "POST", URLString: URLString, parameters: localVariableParameters, headers: localVariableHeaderParameters, requiresAuthentication: true)
        } catch {
            print("Error: \(error)")
