...
open class CustomersAPI {
     ...
     */
    @discardableResult
    open class func createCustomerSync(body: String, apiResponseQueue: DispatchQueue = TexthiveAPI.apiResponseQueue, completion: @escaping ((_ data: Customer?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func createCustomerWithRequestBuilder(
        ...
        do {
            ...
            let localVariableRequestBuilder: RequestBuilder<Customer>.Type = TexthiveAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func deleteCustomerSync(id: String, apiResponseQueue: DispatchQueue = TexthiveAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func deleteCustomerWithRequestBuilder(
        ...
        do {
            try Authentication.setAuthenticationParameters(headers: &localVariableHeaderParameters, url: &localVariableUrlComponents, in: "header", name: "x-api-key", value: TexthiveAPI.apiKey, prefix: nil)
            try Authentication.setAuthenticationParameters(headers: &localVariableHeaderParameters, url: &localVariableUrlComponents, in: "", name: "", value: TexthiveAPI.bearerAuth, prefix: nil)
            let localVariableRequestBuilder: RequestBuilder<Void>.Type = TexthiveAPI.requestBuilderFactory.getNonDecodableBuilder()
            let URLString = localVariableUrlComponents?.string ?? localVariableURLString
     ...
     */
    @discardableResult
    open class func getAllCustomersSync(page: Int, pageSize: Int, apiResponseQueue: DispatchQueue = TexthiveAPI.apiResponseQueue, completion: @escaping ((_ data: [Customer]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func getCustomerByIdSync(id: String, apiResponseQueue: DispatchQueue = TexthiveAPI.apiResponseQueue, completion: @escaping ((_ data: Customer?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func updateCustomerSync(id: String, customersUpdateCustomerRequest: CustomersUpdateCustomerRequest, apiResponseQueue: DispatchQueue = TexthiveAPI.apiResponseQueue, completion: @escaping ((_ data: Customer?, _ error: Error?) -> Void)) -> RequestTask {
