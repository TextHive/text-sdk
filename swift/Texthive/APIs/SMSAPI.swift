...
open class SMSAPI {
     ...
     */
    @discardableResult
    open class func getContactInfoSync(phoneNumber: String, retrieveIfDoesNotExists: Bool, sentId: String? = nil, apiResponseQueue: DispatchQueue = TexthiveAPI.apiResponseQueue, completion: @escaping ((_ data: SMSPayload?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getContactInfoWithRequestBuilder(
        ...
        do {
            ...
            let localVariableRequestBuilder: RequestBuilder<SMSPayload>.Type = TexthiveAPI.requestBuilderFactory.getBuilder()
