...
# Unit tests for Texthive::CustomersUpdateCustomerRequest
describe Texthive::CustomersUpdateCustomerRequest do
  let(:instance) { Texthive::CustomersUpdateCustomerRequest.new }
  ...
  describe 'test an instance of CustomersUpdateCustomerRequest' do
    it 'should create an instance of CustomersUpdateCustomerRequest' do
      expect(instance).to be_instance_of(Texthive::CustomersUpdateCustomerRequest)
    end
  end
