...
/**
 * This class provides a wrapper for network errors when making requests to TextHive Core API
 */
export class TexthiveError extends Error {
  /**
   * The response body
   */
